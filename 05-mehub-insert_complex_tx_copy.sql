...
INSERT INTO public.parsed_message_copy (height, tx_hash, msg_index, detail, msg_type, description)
SELECT height, tx_hash, msg_index, detail, msg_type, description
FROM public.parsed_message
...
-- 2. block -> block_copy
INSERT INTO public.block_copy (height, hash, num_txs, total_gas, proposer_address, "timestamp")
